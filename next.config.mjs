const nextConfig = {
  ...
  async rewrites() {
    ...
    const backendUrl = process.env.NEXT_PUBLIC_BACK_END_BASEURL || 'http://localhost:8003';
    
    console.log('🔧 API Proxy Configuration:');
    console.log('  Backend URL:', backendUrl);
    console.log('  Environment:', process.env.NODE_ENV);
    console.log('  Using env var:', Boolean(process.env.NEXT_PUBLIC_BACK_END_BASEURL));
